# commands/junk_command.rb
# encoding: UTF-8
# [잡동사니] - 10크레딧 소모, 레시피 시트에서 재료 1개 랜덤 획득
...
class JunkCommand
  ...
  def execute
    ...
    if credits < COST
      return "@#{@student_id} 크레딧이 부족합니다. 현재 #{credits}크레딧, 필요 #{COST}크레딧."
    end
    ...
    "@#{@student_id} #{COST}크레딧을 사용해 재료 '#{material}'을(를) 획득했습니다.\n잔여 크레딧: #{new_credits}크레딧"
  end
end
